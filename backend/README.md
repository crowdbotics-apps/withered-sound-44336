...
## Project Structure
    ...
    ├── withered_sound_44336  # Django project configurations
...
1. Clone this repo and `cd withered_sound_44336`
...
2. Clone this repo and `cd withered_sound_44336`

"""
Django settings for withered_sound_44336 project.
...
ROOT_URLCONF = 'withered_sound_44336.urls'
...
WSGI_APPLICATION = 'withered_sound_44336.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_sound_44336 API",
    "DESCRIPTION": "API documentation for withered_sound_44336 App",
    "VERSION": "v1",
}
